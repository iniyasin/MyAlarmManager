package com.example.yasin.myalarmmanager;
...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        int notifId = type.equalsIgnoreCase(TYPE_REPEATING) ? ID_ONETIME : ID_REPEATING;
    ...
    private void showAlarmNotofication(Context context, String title, String message, int notifId){
